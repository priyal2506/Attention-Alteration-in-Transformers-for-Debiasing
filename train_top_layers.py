...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_layers", type=int, default=12, help="Number of top heads showing bias to debias")
    ...
    if args.correlation_type == "pearson":
        layers = [0, 2, 1, 4, 3, 6, 5, 7, 8, 9, 10, 11]
    elif args.correlation_type == "spearman":
        layers = [0, 1, 2, 3, 4, 6, 5, 7, 8, 9, 10, 11]
    elif args.correlation_type == "kendall":
        layers = [0, 2, 1, 3, 4, 5, 6, 7, 10, 8, 11, 9]
